...
const drops = [
  ...
  { num:"DROP III", icon:"📍", title:"Event Finder Engine", concept:"Right place. Right time. Real data.", problem:"Local event discovery is fragmented — APIs exist but data quality and real-time accuracy are inconsistent.", approach:"Aggregated Ticketmaster + Eventbrite APIs into a unified Flask backend with location-based filtering.", stack:["Flask","REST APIs","JavaScript","JSON","HTML/CSS"], outcome:"Functional MVP with live filtering. Normalised competing API data schemas." },
];
...
const skills = [
  ...
  { icon:"🌐", name:"Web Development", desc:"Functional, aesthetic web experiences — Flask backends to polished frontends.", tags:["Flask","HTML","CSS","JavaScript","REST APIs","Jinja2"] },
    ...
    <section id="contact">
      ...
      <div className="reveal" ref={ref}>
        ...
        <div className="social-strip">
          ...
          <a href="https://github.com/aditirawat" target="_blank" rel="noreferrer" className="soc-btn" title="GitHub"><GH/></a>
        </div>
      </div>
    </section>
  );
